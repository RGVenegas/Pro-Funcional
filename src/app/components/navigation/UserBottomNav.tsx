...
export function UserBottomNav({ currentView, onNavigate }: UserBottomNavProps) {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-40 bg-[#06180a] border-t border-[#00E676]/20 shadow-lg">
          ...
          return (
            <button
              ...
              className={`flex flex-col items-center justify-center flex-1 h-full transition-colors ${
                isActive ? 'text-[#00E676] font-bold' : 'text-white/60 hover:text-white'
              }`}
            >
