...
export function UserHome({ user: account, onNavigate }: UserHomeProps) {
  ...
  return (
    <div className="mx-auto max-w-4xl space-y-6">
      {/* Welcome Section */}
      <div className="bg-gradient-to-br from-[#00B4D8]/20 to-[#00B4D8]/5 rounded-2xl p-6 backdrop-blur-sm border border-[#00B4D8]/20 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <span className="text-xs font-bold uppercase tracking-wider text-[#00B4D8]">Centro Kinésico-Deportivo</span>
        ...
        <button
          ...
          className="self-start sm:self-auto px-5 py-2.5 rounded-xl bg-[#00B4D8] text-[#021826] text-xs font-bold hover:bg-[#00B4D8]/90 transition-transform hover:scale-105 shadow-lg shadow-[#00B4D8]/20"
        >
          Agendar Sesión
        </button>
      </div>
      ...
      <div className="bg-white/5 rounded-xl p-5 backdrop-blur-sm border border-white/10 space-y-3">
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="text-xs text-[#00B4D8] font-semibold hover:underline flex items-center gap-1"
          >
        ...
        <div className="space-y-1.5">
          <div className="flex justify-between text-xs font-semibold">
            ...
            <span className="text-[#00B4D8]">{remainingSessions} de {totalSessions} disponibles</span>
          </div>
      ...
      <div className="bg-white/5 rounded-xl p-6 backdrop-blur-sm border border-white/10">
        <div className="flex items-center justify-between mb-4">
          ...
          <span className="text-xs px-2.5 py-0.5 rounded-full bg-[#00B4D8]/20 text-[#00B4D8] font-semibold border border-[#00B4D8]/30">
            {nextSession.type}
          </span>
        </div>
        <div className="flex items-center gap-4">
          <div className="w-12 h-12 bg-[#00B4D8]/20 rounded-xl flex items-center justify-center flex-shrink-0">
          ...
          <div className="text-right">
            ...
            <button
              onClick={() => onNavigate?.('calendar')}
              className="text-xs text-[#00B4D8] hover:underline mt-1 block"
            >
          ...
          return (
            <div key={index} className="bg-white/5 rounded-xl p-4 backdrop-blur-sm border border-white/10">
              <div className="flex items-center gap-3 mb-1.5">
                <div className="w-9 h-9 bg-[#00B4D8]/20 rounded-lg flex items-center justify-center">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        >
          <Calendar className="w-7 h-7 text-[#00B4D8] mb-2 transition-transform group-hover:scale-110" />
          <h3 className="font-bold text-sm mb-1 text-[#F7F7F7]">Reservar Sesión</h3>
          <p className="text-xs text-white/55">Elige horario de forma rápida y sencilla</p>
        </button>
        ...
        <button
          ...
          className="bg-white/5 hover:bg-white/10 rounded-xl p-5 backdrop-blur-sm border border-white/10 transition-all text-left group hover:scale-[1.02]"
        >
          <QrCode className="w-7 h-7 text-[#00B4D8] mb-2 transition-transform group-hover:scale-110" />
