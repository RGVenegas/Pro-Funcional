    ...
    <div className="mx-auto max-w-4xl space-y-6">
      ...
      <div className="bg-gradient-to-br from-[#00E676]/20 to-[#00E676]/5 rounded-2xl p-6 backdrop-blur-sm border border-[#00E676]/30 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <button
          ...
          className="self-start sm:self-auto px-5 py-2.5 rounded-xl bg-[#00E676] text-[#011406] text-xs font-bold hover:bg-[#00E676]/90 transition-transform hover:scale-105 shadow-lg shadow-[#00E676]/20"
        >
          Agendar Sesión
        </button>
      </div>
      ...
      <div className="bg-white/5 rounded-xl p-5 backdrop-blur-sm border border-white/10 space-y-3">
        ...
        <div className="space-y-1.5">
          <div className="flex justify-between text-xs font-semibold">
            ...
            <span className="text-[#00E676]">{remainingSessions} de {totalSessions} disponibles</span>
          </div>
      ...
      <div className="bg-white/5 rounded-xl p-6 backdrop-blur-sm border border-white/10">
        <div className="flex items-center justify-between mb-4">
          ...
          <span className="text-xs px-2.5 py-0.5 rounded-full bg-[#00E676]/20 text-[#00E676] font-semibold border border-[#00E676]/30">
            {nextSession.type}
          </span>
        </div>
        <div className="flex items-center gap-4">
          <div className="w-12 h-12 bg-[#00E676]/20 rounded-xl flex items-center justify-center flex-shrink-0">
          ...
          <div className="text-right">
            ...
            <button
              onClick={() => onNavigate?.('calendar')}
              className="text-xs text-[#00E676] hover:underline mt-1 block"
            >
          ...
          return (
            <div key={index} className="bg-white/5 rounded-xl p-4 backdrop-blur-sm border border-white/10">
              <div className="flex items-center gap-3 mb-1.5">
                <div className="w-9 h-9 bg-[#00E676]/20 rounded-lg flex items-center justify-center">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        >
          <Calendar className="w-7 h-7 text-[#00E676] mb-2 transition-transform group-hover:scale-110" />
        ...
        <button
          ...
          className="bg-white/5 hover:bg-white/10 rounded-xl p-5 backdrop-blur-sm border border-white/10 transition-all text-left group hover:scale-[1.02]"
        >
          <QrCode className="w-7 h-7 text-[#00E676] mb-2 transition-transform group-hover:scale-110" />
