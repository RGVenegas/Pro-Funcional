  ...
  return (
    <div className="space-y-6 max-w-2xl mx-auto">
      <div className="text-center">
        <h1 className="text-3xl font-bold mb-2 text-[#F7F7F7]">Tarjeta digital de membresia</h1>
        <p className="text-white/60">Usa este codigo QR para ingresar al gimnasio</p>
      </div>
          ...
          <div className="relative z-10">
            ...
            <div className="flex items-start justify-between mb-8">
              <div>
                ...
                <p className="text-sm text-white/60">Centro de entrenamiento premium</p>
              </div>
            ...
            <div className="bg-white rounded-2xl p-6 flex flex-col items-center">
              <QRCodeSVG
                ...
                fgColor="#010A01"
              />
              <p className="text-[#010A01] text-sm font-medium mt-4">Escanea en la entrada</p>
            </div>
      ...
      <div className="bg-white/5 rounded-xl p-6 backdrop-blur-sm border border-white/10">
        <h3 className="font-semibold mb-3 text-[#F7F7F7]">Como usarla</h3>
        <ul className="space-y-2 text-sm text-white/80">
          <li className="flex items-start gap-2">
            <span className="text-[#09C82C] mt-1">1.</span>
            <span>Presenta este codigo QR en el lector de la entrada</span>
          </li>
          <li className="flex items-start gap-2">
            <span className="text-[#09C82C] mt-1">2.</span>
            <span>Espera la confirmacion con el check verde</span>
          </li>
          <li className="flex items-start gap-2">
            <span className="text-[#09C82C] mt-1">3.</span>
            <span>Tu ingreso quedara registrado para controlar la asistencia</span>
          </li>
          <li className="flex items-start gap-2">
            <span className="text-[#09C82C] mt-1">4.</span>
            <span>Mantén el brillo del telefono alto para escanear mejor</span>
          </li>
        </ul>
      </div>
